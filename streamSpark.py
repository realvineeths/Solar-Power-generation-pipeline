...
# query = df \
#     .writeStream \
#     .foreachBatch(lambda batchDF, batchId: batchDF.write.jdbc(mysql_url, "streamt2", mode="append",properties=mysql_properties)) \
#     .start()
...
#FOR  PERFORMING AGGREGATION(AVERAGE) OF STREAMING DATA
from pyspark.sql import SparkSession
from pyspark.sql.functions import *
...
df = spark \
    ...
    .option("startingOffsets", "latest") \
    .load()
# WE ARE LISTEINING TO 20 TOPICS AS THESE INDIVIDUALS ARE INVERTED ID's
